...
function ajax() {
    ...
    xhttp.open("GET", "https://api.mapbox.com/geocoding/v5/mapbox.places/madison.json?access_token=pk.eyJ1IjoidGVlYm94bm93IiwiYSI6ImNqZjhjaHc2ZTBudjAzdW16ZTVrMXgycnAifQ.lP0zcYLNYpM7sFy0XljHCw&country=us&types=place", true);
    xhttp.send();
}
...
function fetchTest() {
    if(window.fetch) {
        fetch("https://api.mapbox.com/geocoding/v5/mapbox.places/madison.json?access_token=pk.eyJ1IjoidGVlYm94bm93IiwiYSI6ImNqZjhjaHc2ZTBudjAzdW16ZTVrMXgycnAifQ.lP0zcYLNYpM7sFy0XljHCw&country=us&types=place", {"method":"GET","mode":"cors"}).then(function(response) {
